...
/**
 * Will return the path and default bitcore-node-trvc configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-trvc.json');
