...
/**
 * Will remove a service from trivechaincore-node.json
...
/**
 * Will remove the Node.js service and from the trivechaincore-node configuration.
  ...
  async.eachSeries(
    ...
    function(service, next) {
      ...
      removeService(configPath, service, function(err) {
        ...
        // remove service to trivechaincore-node.json
        removeConfig(trivechaincoreConfigPath, service, next);
      });
    }, done
  );
}
