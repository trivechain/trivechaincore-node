...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.trivechain', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/trivechaincore-node.json';
      ...
      config.services.should.deep.equal(['trivechaind', 'db', 'address', 'web']);
